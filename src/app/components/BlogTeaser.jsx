      ...
      >
        ...
        >
          ...
          <div className="bg-[#1a1a1a] border border-[#33353F] rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-[#525252]/10 border border-[#a3a3a3]/30 rounded-lg flex items-center justify-center mx-auto mb-4">
        ...
        <motion.div variants={itemVariants} className="text-center">
          <div className="bg-gradient-to-r from-[#525252]/10 to-[#404040]/10 border border-[#a3a3a3]/30 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <Link 
              href="/blog"
              className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-[#525252] to-[#404040]
                         text-white font-semibold rounded-full hover:shadow-lg hover:shadow-[#a3a3a3]/25
            ...
            <div className="flex items-center justify-center space-x-8 mt-6 pt-6 border-t border-[#33353F]">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#a3a3a3]">19+</div>
                <div className="text-xs text-[#6B7280]">Articles</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#a3a3a3]">5+</div>
                <div className="text-xs text-[#6B7280]">Categories</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#a3a3a3]">Live</div>
